...
<a href="#" data-id="${c}" class="server-delete"><i class="icon icon-remove-sign"></i></a></td></tr>`
        ...
        $("#btn-client-add-to-option").click(() => {
            ...
            function config_html(client_type,name) {
                let config = "";
...
<dt>Type</dt>
<dd>
    <input class="form-control" name="client" value="${client_type}" disabled/>
</dd>
<dt>Host</dt>
<dd>
    <input type="text" class="form-control" name="host" placeholder="The ip/hostname to connect to" required/>
</dd>
<dt>Port</dt>
<dd>
    <input type="text" class="form-control" name="port" placeholder="The remote port" />
</dd>
<dt>SSL</dt>
<dd>
    <input type="checkbox" name="hostsecure" /> Check if the WebUI runs on SSL (http<strong>s</strong>://). Set the Port to 443!</dd>
<dt>Username</dt>
<dd>
    <input type="text" class="form-control" name="login" placeholder="Login name of the WebUI" required/>
</dd>
<dt>Password</dt>
<dd>
    <input type="password" class="form-control" name="password" placeholder="Password of the WebUI" />
</dd>
<dt>WEB UI</dt>
<dd>
    <input type="text" class="form-control" name="webui" placeholder="The link of WebUI" />
</dd>
</dl>`;  // generalsettings
    ...
    <dt>Relative path</dt>
    <dd>
        <input type="text" name="ruTorrentrelativepath" class="form-control" />
        <br />
        <span class="tip">Enter only the text in quotation marks: http://someserver.com&quot;<strong>/some/path/to/webui</strong>&quot;/<br />
							Note: this folder should contain the "php" directory.</span>
    </dd>
    <dt>Label<br>(optional)</dt>
    <dd>
        <input type="text" name="rutorrentlabel" class="form-control" />
        <span class="tip">Default label to use for added torrents.</span>
    </dd>
    <dt>Directory<br>(optional)</dt>
    <dd>
        <input type="text" name="rutorrentdirectory" class="form-control" />
        <span class="tip">Default directory to store added torrents in. This should be an absolute path. It should be inside your default directory for torrents.</span>
    </dd>

    <dt>Add torrents paused?</dt>
    <dd>
        <input type="checkbox" name="rutorrentaddpaused" />
    </dd>
<!--
...
<dt>Relative path</dt>
<dd><input type="text" name="torrentfluxrelativepath" class="form-control"/>
						<span class="tip">Enter only the text in quotation marks: http://someserver.com&quot;<strong>/some/path/to/webui</strong>&quot;/<br />
							Note: this directory should contain the files "login.php"/"index.php"</span></dd>
</dl>`,
                    "uTorrent WebUI" : `<dl class="dl-horizontal text-overflow dl-client-config">
<dt>Relative path<br />(optional)</dt>
<dd><input type="text" name="utorrentrelativepath" class="form-control"/>
						<span class="tip">Enter only the text in quotation marks: http://someserver.com&quot;<strong>/gui/</strong>&quot;<br />
							Note: Unless you are doing reverse-proxying, this field should be left empty</span></dd>
</dl>`,
                    "Deluge WebUI" : `<dl class="dl-horizontal text-overflow dl-client-config">
<dt>Relative path<br />(optional)</dt>
<dd><input type="text" name="delugerelativepath" class="form-control"/>
						<span class="tip">Enter only the text in quotation marks: http://someserver.com&quot;<strong>/gui</strong>&quot;/<br />
							Note: Unless you are doing reverse-proxying, this field should be left empty</span></dd>
</dl>`,
                    "Hadouken WebUI" : `<dl class="dl-horizontal text-overflow dl-client-config">
<dt>Token</dt>
<dd><input type="text" name="hadoukentoken" class="form-control"/>
						<span class="tip">Mandatory. Enter this instead of Username/Password which will be ignored.<br />
						You can acquire it by clicking your username in the Hadouken WebUI, then API Keys and copying the text.</span></dd>
<dt>Label<br />(optional)</dt>
<dd><input type="text" name="hadoukenlabel" class="form-control"/>
						<span class="tip"></span></dd>
<dt>Directory<br />(optional)</dt>
<dd><input type="text" name="hadoukendir" class="form-control"/>
						<span class="tip"></span></dd>
</dl>`,
                    "flood WebUI" : `<dl class="dl-horizontal text-overflow dl-client-config">
<dt>>Directory<br />(optional)</dt>
<dd><input type="text" name="flooddirectory" class="form-control"/>
						<span class="tip">Default directory to store added torrents in. This should be an absolute path. It should be inside your default directory for torrents.</span></dd>
<dt>>Add torrents paused?</dt>
<dd><input type="checkbox" name="floodaddpaused" /></dd>
</dl>`,
                    "QNAP DownloadStation" : `<dl class="dl-horizontal text-overflow dl-client-config">
<dt>Temp Directory</dt>
<dd><input type="text" name="qnaptemp" class="form-control" />
						<span class="tip">Directory used while downloading/seeding.</span></dd>
<dt>Destination Directory</dt>
<dd><input type="text" name="qnapmove" class="form-control"/>
						<span class="tip">After torrent has completed it will be moved to this directory.</span></dd>
</dl>`,
...
<dd><input type="text" name="utorrentrelativepath" class="form-control"/>
            ...
            $("#server-add-modal-option-context").html(config_html(client_type,name));

            $('[data-toggle="tooltip"]').tooltip();
            // 切换显示窗口
            $("#server-add-modal-type").hide();
            $("#server-add-modal-option").show();
        })
        ...
        $("#btn-client-add-to-completed").click(() => {
            ...
            $("#server-add-modal-option input[type='text']").each(function(){
                let that = $(this);
                clientObj[that.attr("name")] = that.val();
            });
            $("#server-add-modal-option input[type='checkbox']").each(function(){
                let that = $(this);
                clientObj[that.attr("name")] = that.prop("checked");
            });

            system.config.servers.push(clientObj);
            system.saveConfig();
            ClientTable();
            $("#server-add-modal-type").show();
            $("#server-add-modal-option").hide();
